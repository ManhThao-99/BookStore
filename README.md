...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 41925e14-6933-4880-9be4-8557c10a7439
```

> `41925e14-6933-4880-9be4-8557c10a7439` is the password of the certificate, you can change it to any password you want.
